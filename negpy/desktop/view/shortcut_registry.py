...
REGISTRY: dict[str, ShortcutEntry] = {
    ...
    "toggle_sidecar_mirror": ShortcutEntry("", "Keep Current: mirror each edit, mark and work print to .negpy sidecars", "Actions"),
    "export_sidecars": ShortcutEntry("", "Write .negpy sidecars for every visible frame now", "Actions"),
